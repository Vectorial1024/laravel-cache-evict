...
namespace Vectorial1024\LaravelCacheEvict\Test\MariaDB;
...
class MariaDBEvictTest extends AbstractDatabaseCacheEvictTestCase
{
...
SQL);
        ...
        Config::set('database.connections.mariadb.username', $dbUser);
        Config::set('database.connections.mariadb.password', $dbPass);
        Config::set('database.connections.mariadb.charset', 'utf8mb4');
